                ...
                {tempLoading ? (
                  ...
                  <div className="relative inline-flex">
                    <CircularProgress
                      variant="determinate"
                      value={
                        tempInfo.value < tempInfo.lowerThreshold
                          ? tempInfo.value
                          : tempInfo.lowerThreshold - 0.1
                      }
                      size={250}
                      thickness={3}
                    ...
                    <CircularProgress
                      variant="determinate"
                      value={
                        tempInfo.value > tempInfo.upperThreshold
                          ? tempInfo.upperThreshold -
                            tempInfo.lowerThreshold -
                            0.4
                          : tempInfo.value > tempInfo.lowerThreshold
                            ? tempInfo.value - tempInfo.lowerThreshold - 0.4
                            : 0
                      }
                      size={250}
                      thickness={3}
                      ...
                      style={{
                        transform:
                          "rotate(" +
                          (Math.floor(
                            90 + (tempInfo.lowerThreshold * 360) / 100
                          ) +
                            1) +
                          "deg)",
                        position: "absolute",
                    ...
                    <CircularProgress
                      ...
                      value={
                        tempInfo.value > tempInfo.upperThreshold
                          ? tempInfo.value - tempInfo.upperThreshold - 0.4
                          : 0
                      }
                      size={250}
                      thickness={3}
                      ...
                      style={{
                        transform:
                          "rotate(" +
                          (Math.floor(
                            90 + (tempInfo.upperThreshold * 360) / 100
                          ) +
                            1) +
                          "deg)",
                        position: "absolute",
                    ...
                    <CircularProgress
                      variant="determinate"
                      value={tempInfo.lowerThreshold - 0.01}
                      size={250}
                      thickness={3}
                      style={{
                        color: "lightGray",
                    ...
                    <CircularProgress
                      variant="determinate"
                      value={
                        tempInfo.upperThreshold - tempInfo.lowerThreshold - 0.4
                      }
                      size={250}
                      thickness={3}
                      style={{
                    ...
                    <CircularProgress
                      variant="determinate"
                      value={100 - tempInfo.upperThreshold - 0.4}
                      size={250}
                      thickness={3}
                      style={{
                        color: "lightGray",
                    ...
                    <div className="flex top-0 left-0 bottom-0 right-0 absolute justify-center items-center">
                      <div className="flex flex-col justify-center items-center">
                        <img
                          src={
                            tempInfo.needNoti
                              ? TemperatureCelsiusWarning
                              : TemperatureCelsiusGood
                          }
                        />
                        <div
                          className={
                            "font-bold text-[1.5rem] text-center" +
                            (tempInfo.needNoti
                              ? " text-warning"
                              : " text-success")
                          }
                        ...
                        <div>{formatDateInfo(tempInfo.time)}</div>
                      </div>
                    </div>
                  </div>
                )}
                ...
                {lightLoading ? (
                  ...
                  <div className="relative inline-flex">
                    <CircularProgress
                      variant="determinate"
                      value={
                        lightInfo.valuePercent < lightInfo.lowerThresholdPercent
                          ? lightInfo.valuePercent
                          : lightInfo.lowerThresholdPercent - 0.1
                      }
                      size={250}
                      thickness={3}
                    ...
                    <CircularProgress
                      variant="determinate"
                      value={
                        lightInfo.valuePercent > lightInfo.upperThresholdPercent
                          ? lightInfo.upperThresholdPercent -
                            lightInfo.lowerThresholdPercent -
                            0.4
                          : lightInfo.valuePercent >
                              lightInfo.lowerThresholdPercent
                            ? lightInfo.valuePercent -
                      ...
                      style={{
                        transform:
                          "rotate(" +
                          (Math.floor(
                            90 + (lightInfo.lowerThresholdPercent * 360) / 100
                          ) +
                            1) +
                          "deg)",
                        position: "absolute",
                    ...
                    <CircularProgress
                      ...
                      style={{
                        transform:
                          "rotate(" +
                          (Math.floor(
                            90 + (lightInfo.upperThresholdPercent * 360) / 100
                          ) +
                            1) +
                          "deg)",
                        position: "absolute",
                    ...
                    <CircularProgress
                      variant="determinate"
                      value={lightInfo.lowerThresholdPercent - 0.01}
                      size={250}
                      thickness={3}
                      style={{
                        color: "lightGray",
                    ...
                    <CircularProgress
                      variant="determinate"
                      value={100 - lightInfo.upperThresholdPercent - 0.4}
                      size={250}
                      thickness={3}
                      style={{
                        color: "lightGray",
                    ...
                    <div className="flex top-0 left-0 bottom-0 right-0 absolute justify-center items-center">
                      <div className="flex flex-col justify-center items-center">
                        ...
                        >
                          ...
                          <div className="font-normal text-[1rem]">
                            {lightInfo.needNoti
                              ? "Ánh sáng ngoài ngưỡng"
                              : "Ánh sáng bình thường"}
                          </div>
                        </div>
                        <div>{formatDateInfo(lightInfo.time)}</div>
                      </div>
                    </div>
                  </div>
                )}
                ...
                {humidLoading ? (
                  ...
                  <div className="relative inline-flex">
                    <CircularProgress
                      variant="determinate"
                      value={
                        humidInfo.value < humidInfo.lowerThreshold
                          ? humidInfo.value
                          : humidInfo.lowerThreshold - 0.1
                      }
                      size={250}
                      thickness={3}
                    ...
                    <CircularProgress
                      variant="determinate"
                      value={
                        humidInfo.value > humidInfo.upperThreshold
                          ? humidInfo.upperThreshold -
                            humidInfo.lowerThreshold -
                            0.4
                          : humidInfo.value > humidInfo.lowerThreshold
                            ? humidInfo.value - humidInfo.lowerThreshold - 0.4
                            : 0
                      }
                      size={250}
                      thickness={3}
                      ...
                      style={{
                        transform:
                          "rotate(" +
                          (Math.floor(
                            90 + (humidInfo.lowerThreshold * 360) / 100
                          ) +
                            1) +
                          "deg)",
                        position: "absolute",
                    ...
                    <CircularProgress
                      ...
                      value={
                        humidInfo.value > humidInfo.upperThreshold
                          ? humidInfo.value - humidInfo.upperThreshold - 0.4
                          : 0
                      }
                      size={250}
                      thickness={3}
                      ...
                      style={{
                        transform:
                          "rotate(" +
                          (Math.floor(
                            90 + (humidInfo.upperThreshold * 360) / 100
                          ) +
                            1) +
                          "deg)",
                        position: "absolute",
                    ...
                    <CircularProgress
                      variant="determinate"
                      value={humidInfo.lowerThreshold - 0.01}
                      size={250}
                      thickness={3}
                      style={{
                        color: "lightGray",
                    ...
                    <CircularProgress
                      variant="determinate"
                      value={100 - humidInfo.upperThreshold - 0.4}
                      size={250}
                      thickness={3}
                      style={{
                        color: "lightGray",
                    ...
                    <div className="flex top-0 left-0 bottom-0 right-0 absolute justify-center items-center">
                      <div className="flex flex-col justify-center items-center">
                        ...
                        <div>{formatDateInfo(humidInfo.time)}</div>
                      </div>
                    </div>
                  </div>
                )}
                ...
                {moistureLoading ? (
                  ...
                  <div className="relative inline-flex">
                    <CircularProgress
                      variant="determinate"
                      value={
                        moistureInfo.value < moistureInfo.lowerThreshold
                          ? moistureInfo.value
                          : moistureInfo.lowerThreshold - 0.1
                      }
                      size={250}
                      thickness={3}
                    ...
                    <CircularProgress
                      variant="determinate"
                      value={
                        moistureInfo.value > moistureInfo.upperThreshold
                          ? moistureInfo.upperThreshold -
                            moistureInfo.lowerThreshold -
                            0.4
                          : moistureInfo.value > moistureInfo.lowerThreshold
                            ? moistureInfo.value -
                              moistureInfo.lowerThreshold -
                      ...
                      style={{
                        transform:
                          "rotate(" +
                          (Math.floor(
                            90 + (moistureInfo.lowerThreshold * 360) / 100
                          ) +
                            1) +
                          "deg)",
                        position: "absolute",
                    ...
                    <CircularProgress
                      ...
                      style={{
                        transform:
                          "rotate(" +
                          (Math.floor(
                            90 + (moistureInfo.upperThreshold * 360) / 100
                          ) +
                            1) +
                          "deg)",
                        position: "absolute",
                    ...
                    <CircularProgress
                      variant="determinate"
                      value={moistureInfo.lowerThreshold - 0.01}
                      size={250}
                      thickness={3}
                      style={{
                        color: "lightGray",
                    ...
                    <CircularProgress
                      variant="determinate"
                      value={100 - moistureInfo.upperThreshold - 0.4}
                      size={250}
                      thickness={3}
                      style={{
                        color: "lightGray",
                    ...
                    <div className="flex top-0 left-0 bottom-0 right-0 absolute justify-center items-center">
                      <div className="flex flex-col justify-center items-center">
                        ...
                        <div>{formatDateInfo(moistureInfo.time)}</div>
                      </div>
                    </div>
                  </div>
                )}
